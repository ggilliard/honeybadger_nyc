...
Developing any type of application requires a degree of comfort navigating and interacting with your operating system through the command line, we'll be practicing creating, modifying, and moving files and folders in your terminal to get you practicing Unix commands.
...
- There is no need to perform actions in the command line. Please write all solutions in the solutions.txt file.
...
Be sure you open up your "my-favorite-things" directory in Sublie/Atom/VSCode, so you can track your progress. Here's a look at what your files/folders should look like after each big step in the exercise:
